...
public final class ActivitySettingsBinding implements ViewBinding {
  ...
  private ActivitySettingsBinding(@NonNull CoordinatorLayout rootView,
      @NonNull Slider sliderAcceleration, @NonNull Slider sliderRotation,
      @NonNull Spinner spinnerSensitivity, @NonNull SwitchMaterial switchAutoCall,
      @NonNull SwitchMaterial switchAutoSms, @NonNull SwitchMaterial switchDarkMode,
  ...
  public static ActivitySettingsBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivitySettingsBinding((CoordinatorLayout) rootView, sliderAcceleration,
          sliderRotation, spinnerSensitivity, switchAutoCall, switchAutoSms, switchDarkMode,
          toolbar);
    }
